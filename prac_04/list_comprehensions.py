...
# use a list comprehension to create a list of only the numbers that are greater than 9 from the numbers (not strings)
# you just created
big_numbers = [int(almost_number) for almost_number in almost_numbers if int(almost_number) > 9]
print(big_numbers)
